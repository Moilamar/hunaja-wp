...
Kirki::add_field( 'switty_config', array(
	...
	'section'     => 'themeinfo',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">' . __( 'Please follow', 'switty' ) . ' <a target="_blank" href="http://rinkuyadav.com/switty/switty-theme-documentation/"> ' . __( 'Docs page', 'switty' ) . '</a>  ' . __( 'for all features and functions.', 'switty') . ' </div>',
	'priority'    => 10,
) );
...
Kirki::add_field( 'switty_config', array(
	'type'        => 'custom',
	'settings'    => 'info_demo',
	'label'       => esc_attr__( 'Theme Demo', 'switty' ),
	'section'     => 'themeinfo',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">' . __( 'Want to visit Demo website? You can check', 'switty' ) . ' <a target="_blank" href="http://rinkuyadav.com/switty/"> ' . __( 'Demo Website here', 'switty' ) . '</a>.</div>',
	'priority'    => 10,
) );
...
Kirki::add_field( 'switty_config', array(
	...
	'section'     => 'themeinfo',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">' . __( 'Do you want my support? You can create', 'switty' ) . ' <a target="_blank" href="http://wordpress.org/support/theme/switty"> ' . __( 'Support Topic here', 'switty' ) . '</a>.</div>',
	'priority'    => 10,
) );
